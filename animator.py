...
class Worker:
    ...
    def read_midi_message(self, msg, metronome_1, human_1, lfo_list, cpu_list, T0, timing_array, metronome_error, out_queue, metronome_timestamp):
    ...
    def worker_main(self, lfo_list, cpu_list, T0, timing_array, metronome_error, metronome_timestamp, in_queue, out_queue,):
        ...
        while 1:
            msg = in_queue.get()
            self.read_midi_message(msg, metronome_1, human_1, lfo_list, cpu_list, T0, timing_array, metronome_error, out_queue, metronome_timestamp)
